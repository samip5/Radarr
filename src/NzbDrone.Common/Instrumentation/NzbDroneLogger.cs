...
namespace NzbDrone.Common.Instrumentation
{
    public static class NzbDroneLogger
    {
        ...
        private static void RegisterConsole()
        {
            ...
            coloredConsoleTarget.Layout = @"${date:format=yyyy-M-d HH\:mm\:ss.ff}|[${level}] ${logger}: ${message} ${onexception:inner=${newline}${newline}[v${assembly-version}] ${exception:format=ToString}${newline}}";
